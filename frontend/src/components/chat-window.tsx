...
export function ChatWindow() {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-transparent relative">
      ...
      <div className="flex items-center gap-4 px-6 py-8 md:px-12 bg-transparent sticky top-0 z-20">
      ...
      {/* Messages */}
      <ScrollArea className="flex-1 px-6 md:px-12" ref={scrollRef}>
        <div className="py-8 space-y-8 max-w-5xl mx-auto w-full">
          {messages.length === 0 && (
