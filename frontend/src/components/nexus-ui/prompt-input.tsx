  ...
  return (
    <PromptInputContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          "relative flex h-auto w-full cursor-text flex-col gap-0 overflow-hidden rounded-[24px] border border-white/10 bg-white/5 backdrop-blur-xl",
          className,
        )}
        onClick={handleClick}
        {...props}
  ...
  return (
    <ScrollArea className="max-h-40">
      <Textarea
        ...
        className={cn(
          "min-h-14 w-full resize-none border-0 bg-transparent px-4 py-4 text-base leading-6 font-normal text-white shadow-none outline-none placeholder:text-white/40 focus-visible:ring-0 focus-visible:ring-offset-0 dark:bg-transparent",
          className,
        )}
